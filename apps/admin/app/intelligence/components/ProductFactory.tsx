...
const STEPS = [
  { key: "rawListings", label: "Importiert", href: "/market/dashboard" },
  { key: "enriched", label: "Angereichert", href: "/market/dashboard" },
  { key: "analyzed", label: "Bewertet", href: "/market/dashboard" },
