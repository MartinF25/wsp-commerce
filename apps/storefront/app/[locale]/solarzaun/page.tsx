  ...
  return (
    <main>
      <SolutionHero
        ...
        image={{ src: "/images/solarzaun-house.png", alt: "Solarzaun am modernen Wohnhaus" }}
        imageLabel="Solarzaun als sichtbares Produkt- und Anwendungsvisual im Wohnumfeld."
      />
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-brand-muted leading-relaxed mb-6">{t("trust_p1")}</p>
      ...
      <section className="bg-brand-text py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/products" className="inline-block border border-gray-600 text-white font-semibold px-9 py-3.5 rounded-xl hover:border-gray-400 transition-colors duration-150">{t("cta_secondary")}</Link>
          </div>
        </div>
      </section>
    </main>
